...
class TerminalManager extends basemanager_1.BaseManager {
    ...
    constructor(options = {}) {
        ...
        this._terminalAPIClient =
            (_a = options.terminalAPIClient) !== null && _a !== void 0 ? _a : new restapi_1.TerminalAPIClient({ serverSettings: this.serverSettings });
    ...
    async shutdownAll() {
        ...
        await Promise.all(this._names.map(name => this._terminalAPIClient.shutdown(name)));
