...
export interface IKernelConnection extends IObservableDisposable {
     ...
     * @returns A promise that resolves with the response message.
     */
    requestCreateSubshell(content: KernelMessage.ICreateSubshellRequestMsg['content'], disposeOnDone?: boolean): IControlFuture<KernelMessage.ICreateSubshellRequestMsg, KernelMessage.ICreateSubshellReplyMsg>;
    /**
     ...
     * @returns A promise that resolves with the response message.
     */
    requestDeleteSubshell(content: KernelMessage.IDeleteSubshellRequestMsg['content'], disposeOnDone?: boolean): IControlFuture<KernelMessage.IDeleteSubshellRequestMsg, KernelMessage.IDeleteSubshellReplyMsg>;
    /**
     ...
     * @returns A promise that resolves with the response message.
     */
    requestListSubshell(content: KernelMessage.IListSubshellRequestMsg['content'], disposeOnDone?: boolean): IControlFuture<KernelMessage.IListSubshellRequestMsg, KernelMessage.IListSubshellReplyMsg>;
    /**
